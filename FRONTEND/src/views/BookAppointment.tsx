...
export default function BookAppointment() {
    ...
    return (
        <>
            ...
            <section className={"px-52 flex mt-10"}>
                <section>
                    <div className={"card-bg"}>
                        ...
                        <div>
                            <p>DR Prem Duairajah</p>
                            <p>AESTHETIC COSMETIC CENTERE</p>
                        </div>
                        <div>
                    ...
                    <div>
                        <div>
                            <img src="/src/assets/img/sessions/H483.jpg" alt=""/>
                        </div>
                        <div>
                            <p>Health + (Pvt) Ltd</p>
                            <div>
                            ...
                            <div>
                                ...
                                <p>1</p>
                                <p>Your estimated appointment time is 11:00 AM. This time is depending on the time spend
                ...
                <section>
                    ...
                    <div>
                        <CustomSelect lableValue={"Title"} id={"userTitle"} options={userTitle} lableColor={true}/>
                        <CustomTextInput lableName={"Patient Name"} name={"text"} lableColor={true}/>
                    </div>

                    <div>
                        <CustomSelect lableValue={"Mobile Number"} id={"userTitle"} options={[{options:"+94", values:"+94"}]} lableColor={true}/>
                    ...
                    <div>
                        <img src="https://www.echannelling.com/images/icons/info-icon.svg" alt=""/>
                        <p>Opt for No Show Refund<br/>
                            If appointment is cancelled or no show, the total charge will be refunded without LKR 250/= service charge.
