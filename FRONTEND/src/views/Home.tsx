...
export default function Home(): React.JSX.Element {
    ...
    return (
        <>
            ...
            {/* main hero */}
            <main>
                <div className={"px-10 flex hero-container w-full"}>
                    <div className={"my-5 flex flex-col justify-center w-full gap-y-8"}>
                        {/* left */}
                        <div>
                            <p className={"text-[#4d4b4b] font-[Rubik,serif] font-medium text-[22px]"}>❤️ Health comes
                                first</p>
                        </div>
                        <div>
                            <p className={" w-[550px] text-black font-[700] text-[40px]"}>Find your Doctor and make and
                                Appointments</p>
                        </div>
                        <div>
                        ...
                        <div>
                            <button
                                ...
                                <svg width={"14px"} aria-hidden="true" focusable="false" data-prefix="fas"
                                     ...
                                     className="svg-inline--fa fa-calendar-check group-hover:fill-amber-500 " role="img"
                        ...
                        <div className={"flex gap-x-5"}>
                            <div className={"flex flex-col items-center"}>
                                <p className={"text-[32px] font-[Rubik] text-[#1a8efd] font-medium"}>145k+</p>
                                <p className={"text-[22px] font-[Poppins] text-[#4d4b4b]"}>Receive Patients</p>
                            </div>

                            <div className={"flex flex-col items-center"}>
                                <p className={"text-[32px] font-[Rubik] text-[#1a8efd] font-medium"}>50+</p>
                                <p className={"text-[22px] font-[Poppins] text-[#4d4b4b]"}>Expert Doctors</p>
                            </div>

                            <div className={"flex flex-col items-center"}>
                                <p className={"text-[32px] font-[Rubik] text-[#1a8efd] font-medium"}>10+</p>
                                <p className={"text-[22px] font-[Poppins] text-[#4d4b4b]"}>Years of Experience</p>
                            </div>
                        </div>
                    </div>
