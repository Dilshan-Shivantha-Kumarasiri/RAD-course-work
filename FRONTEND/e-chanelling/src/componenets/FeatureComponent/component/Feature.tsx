...
export default function Feature(props:Props): JSX.Element {
    return (
        ...
        <div className={` text-white p-10  ${props.bg}`}>
            <div className={"flex justify-center items-center"}>
                <i className={`m-auto border w-[40px] h-[40px] flex justify-center items-center`}>
                    <FontAwesomeIcon className={"text-[30px] "} icon={props.icons}/>
                </i>
            </div>
